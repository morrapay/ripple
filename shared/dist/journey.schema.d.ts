 ...
 */
export type CommunicationChannel = "email" | "sms" | "push" | "in_app" | "whatsapp" | "webhook";
/**
 ...
 */
export type JourneyStep = (StepBase & {
    type: "event";
    config: EventStepConfig;
}) | (StepBase & {
    type: "delay";
...
export {};
//# sourceMappingURL=journey.schema.d.ts.map